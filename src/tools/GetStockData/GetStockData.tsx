...
export type GetStockDataToolInputNode = AirNode<{
...
export type GetStockDataToolOutputNode = AirNode<{
    ...
    next_url?: string
}, 'GetStockDataToolOutputNode'>

export const GetStockDataToolExecution:FC<{
    input: GetStockDataToolInputNode,
    returnFn: (output: Record<string, any>) => void
}> = ({input, returnFn}) => {
    const polygon = usePolygon()
    useEdge(async ([{stocksTicker, multiplier, timespan, from, to}]) => {
